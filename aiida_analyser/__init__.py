...
_EXPORTS = {
    ...
    'DosCalculationAnalyser': ('quantumespresso.dos_calculation', 'DosCalculationAnalyser', None),
    'PhCalculationAnalyser': ('quantumespresso.ph_calculation', 'PhCalculationAnalyser', None),
    'MatdynCalculationAnalyser': ('quantumespresso.matdyn_calculation', 'MatdynCalculationAnalyser', None),
    'ProjwfcCalculationAnalyser': ('quantumespresso.projwfc_calculation', 'ProjwfcCalculationAnalyser', None),
    'Pw2Wannier90CalculationAnalyser': ('quantumespresso.pw2wannier90_calculation', 'Pw2Wannier90CalculationAnalyser', None),
    'Q2rCalculationAnalyser': ('quantumespresso.q2r_calculation', 'Q2rCalculationAnalyser', None),
    ...
    'ThermoPwBaseAnalyser': ('thermo_pw.thermo_pw', 'ThermoPwBaseAnalyser', 'thermo'),
    'ThermoPwGroupData': ('thermo_pw.thermo_pw', 'ThermoPwGroupData', 'thermo'),
